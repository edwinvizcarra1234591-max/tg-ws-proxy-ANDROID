...
### 3. Настройте прокси
По заходу, будут выставлены дефолтные настройки самого прокси от Flowseal. Чаще всего вам придется поменять порт с 1080 на какой-нибудь другой, незанятый порт. (Порт 1080 может быть занят ByeByeDPI или подобными приложениями)
### 4. Запустите прокси
